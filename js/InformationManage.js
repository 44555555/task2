...
$(function(){
    ...
    $(document).on("click",".addButton_ok",function(){
        ...
        var str='<tr>' +
            ...
            '<td class="name">'+arrAdd[0]+'</td>' +
            '<td class="num">'+arrAdd[1]+'</td>' +
            '<td class="unit">'+arrAdd[2]+'</td>' +
            '<td class="adds">'+arrAdd[3]+'</td>' +
            '<td class="price">'+arrAdd[4]+'</td>' +
            '<td class="putAdds">'+arrAdd[5]+'</td>' +
            '<td class="time">'+arrAdd[6]+'</td>' +
            '<td class="supplier">'+arrAdd[7]+'</td>' +
